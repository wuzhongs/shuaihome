<template>
  <div class="product">
    <product-param :title="product.name">
      <template v-slot:buy>
        <button class="btn" @click="buy">点击购买</button>
      </template>
    </product-param>
    <div class="content">
      <div class="item-bg">
      ...
      <div class="item-video">
        ...
        <div class="video-box" v-if="slideVideoBox">
          <div class="overlay"  ></div>
          <div class="video" v-bind:class="{'slide':showSlide}">
              <span class="icon-close" @click="slideDown"></span>
